...
export class IoTHubMessageExplorer extends IoTHubMessageBaseExplorer {
	...
	constructor(outputChannel: vscode.OutputChannel) {
		super(
			outputChannel,
			"$(primitive-square) Stop Monitoring built-in event endpoint",
	...
	public async startMonitorIoTHubMessage(deviceItem?: DeviceItem) {
		...
		const connectionString = await Utility.getConnectionString(
			Constants.IotHubEventHubConnectionStringKey,
			Constants.IotHubEventHubConnectionStringTitle,
			true,
	...
	public stopMonitorIoTHubMessage(): void {
		this.stopMonitorEventHubEndpoint(
			Constants.IoTHubMonitorLabel,
			Constants.IoTHubAIStopMonitorEvent,
